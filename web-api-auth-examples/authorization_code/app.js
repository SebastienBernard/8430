...
var spotifyLogin = express();

spotifyLogin.use(express.static(__dirname + '/public'))
   .use(cookieParser());

spotifyLogin.get('/login', function(req, res) {
...
spotifyLogin.get('/callback', function(req, res) {
...
spotifyLogin.get('/refresh_token', function(req, res) {
